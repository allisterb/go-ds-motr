// Based on: https://github.com/cockroachdb/cockroach/blob/master/pkg/util/uint128/uint128.go
// uint128.go has the following copyright notice:
//
...
func FromString(s string) (Uint128, error) {
	...
	if err != nil {
		return Uint128{}, fmt.Errorf("could not decode %s as hex: %w", s, err)
	}
