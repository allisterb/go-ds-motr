...
if [ -f "02 Track02.flac" ]; then
   ...
   echo Downloading 02 Track02.flac from IPFS gateway...
...
if [ -f "03 Track03.flac" ]; then
   ...
   echo Downloading 03 Track03.flac from IPFS gateway...
...
if [ -f "04 Track04.flac" ]; then
   ...
   echo Downloading 04 Track04.flac from IPFS gateway...
...
if [ -f "05 Video 01.webm" ]; then
    echo 04 05 Video 01.webm already exists in this folder.
else
   echo Downloading 05 Video 01.webm from IPFS gateway...
